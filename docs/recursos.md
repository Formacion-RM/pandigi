...
!!!alert "Tipo de trazo"
    ...
    Si se utiliza un puntero este efecto resulta más preciso.
...
Al desactivar la **capa de transparencia** se realiza una captura de la pantalla, con las anotaciones realizadas. De esta forma posteriormente las anotaciones también pueden ser compartidas o recuperadas para poder volver a mostrarlas.
